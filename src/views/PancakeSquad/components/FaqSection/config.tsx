...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Faisaa.finance Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Faisaa.finance Bunny NFTs at the snapshot may also purchase one additional Faisaa.finance Squad NFT in the presale for each Faisaa.finance Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of FAISAA spent on Faisaa.finance Squad NFTs will be burned as part of our weekly FAISAA burn.')],
  },
  {
