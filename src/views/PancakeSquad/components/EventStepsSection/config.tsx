  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active WagyuSwap Profile to buy Minting Tickets and mint a Faisaa.finance Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold FAISAA'),
      bodyText: [t('Each NFT costs FAISAA to mint. Remember you also need VLX to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://faisaa.finance/swap?outputCurrency=0xaBf26902Fd7B624e0db40D31171eA9ddDf078351"
            target="_blank"
            width="100%"
          >
            {t('Buy FAISAA')}
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” Faisaa.finance Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active Faisaa.finance Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      bodyText: [
        t(
          'During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a Faisaa.finance Squad NFT.',
        ),
      ],
      buttons: (
        <>
