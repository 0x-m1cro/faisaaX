import { JSBI, Token, TokenAmount } from '@faisaa-finance/sdk'
...
describe('limitOrders/utils/getPriceForOneToken', () => {
  describe.each([
    [new TokenAmount(FAISAA, ONE), new TokenAmount(BUSD, ONE), '1'],
    [new TokenAmount(FAISAA, FIVE), new TokenAmount(BUSD, FIVE), '1'],
    [new TokenAmount(FAISAA, ONE), new TokenAmount(BUSD, FIVE), '5'],
    [new TokenAmount(FAISAA, FIVE), new TokenAmount(BUSD, ONE), '0.2'],
    ...
    [new TokenAmount(FAISAA, ZERO), new TokenAmount(BUSD, ONE), undefined],
    [new TokenAmount(FAISAA, ONE), new TokenAmount(BUSD, ZERO), undefined],
